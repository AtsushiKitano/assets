...
resource "google_dns_record_set" "main" {
  ...
  name         = var.record_sets[count.index].name == null ? google_dns_managed_zone.main.dns_name : join(".", [var.record_sets[count.index].name, google_dns_managed_zone.main.dns_name])
